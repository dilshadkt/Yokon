...
const OurStory = () => {
  return (
    <div className="flex items-center justify-center h-screen sm:h-full px-[5%] lg:px-0 sm:px-5 sm:py-[15%]">
      <div className="w-full  h-[81%] flex  sm:flex-col">
        <div className="flex-initial w-[45%]  sm:w-full     flex items-start   justify-end">
          <div className=" flex flex-col items-center w-[60%] lg:w-[80%] sm:w-full my-[6%] sm:my-0">
